...
import { softDeleteQuiz } from "@/actions/quiz";
...
const DeleteQuizModal = ({ setIsOpenPopover, uuid }: DeleteQuizModalProps) => {
  ...
  const handleDelete = async () => {
    try {
      ...
      const result = await softDeleteQuiz(uuid);
      ...
      <DialogContent
        ...
        <DialogHeader className="p-6">
          ...
          <DialogDescription className="text-muted-foreground">
            Kamu yakin ingin menghapus quiz ini? Tindakan ini tidak dapat
            diurungkan.
          </DialogDescription>
        </DialogHeader>
