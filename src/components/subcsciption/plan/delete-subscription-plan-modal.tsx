...
import { softDeleteSubscriptionPlanAdmin } from "@/actions/subscription-plans";
...
const DeleteSubscriptionPlanModal = ({
  setIsOpenPopover,
  uuid,
  ...
  const handleDelete = async () => {
    try {
      ...
      const result = await softDeleteSubscriptionPlanAdmin(uuid);
